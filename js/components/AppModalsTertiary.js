export default function AppModalsTertiary({
  ...
  const getPalletsInUse = React.useCallback((targetRoute) => (
    (targetRoute.stores || []).reduce(
      (total, store) => total + (store.pallets || []).filter((p) => p && p > 0).length,
      0
    )
  ), []);
      ...
      /*#__PURE__*/React.createElement(
        ...
        /*#__PURE__*/React.createElement(
          ...
          destinationRoutes.map((targetRoute) => {
            ...
            const palletsInUse = getPalletsInUse(targetRoute);
            return /*#__PURE__*/React.createElement(
              "div",
              {
                key: targetRoute.id,
