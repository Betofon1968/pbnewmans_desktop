...
import {guardPastDatePrint} from './modules/utils/pastDatePrintGuard.js';
...
const generateBOL=async route=>{const ok=await guardPastDatePrint({kind:'BOL',selectedDate,timezone,setPastDatePrintModal});if(!ok)return;return generateBOLDocument({route,routes,selectedDate,bolSettings,palletTypes,storesDirectory,escapeHtml});};// ─────────────────────────────────────────────────────────────────────────
// ╔╗
